...
pnpm install sqlite3 @prisma/client prisma 
pnpm install morgan dotenv
...
# Write model definitions to the Prisma schema file
...
echo "$MODEL_CONTENT" > ./prisma/schema.prisma


# Generate Mock Data

MOVIE_CONTENT=$(cat << 'EOF'
export default [
  {
    title: 'The Matrix',
...
echo "$MOVIE_CONTENT" > ./prisma/movie.js
...
echo "$SEED_SCRIPT" > ./prisma/seed.js
